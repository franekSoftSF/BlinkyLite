...
| D-21 | **Profile na serwerze**, konfigurowane odgórnie przez admina; klient pobiera je przez `GET /api/profiles` i wysyła nazwę profilu, nigdy nazwę szablonu | jedna zmiana zamiast obchodu po stacjach; szablon i CA zna tylko serwer, więc podmieniony klient nie wskaże dowolnego szablonu; wydanie kopiuje profil i szablon do swojego wiersza, żeby zmiana konfiguracji nie przepisała historii |
