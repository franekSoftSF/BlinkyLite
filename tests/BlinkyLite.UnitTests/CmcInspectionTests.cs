...
/// <c>EMS-AD%5Cszymon.frankiewicz</c> and was reported as a mismatch. The name
...
public sealed class CmcInspectionTests
{
    ...
    [InlineData("requestername=EMS-AD%5Cszymon.frankiewicz", @"EMS-AD\szymon.frankiewicz")]
    [InlineData("requestername=EMS-AD\\szymon.frankiewicz", @"EMS-AD\szymon.frankiewicz")]
